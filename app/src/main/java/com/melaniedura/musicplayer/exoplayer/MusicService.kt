...
class MusicService: MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        //get activityIntent for the service notification
    ...
    /**
     * Gets the MediaDescriptionCompat (set of metadata for a media item) for a given timeline window index (index of song that is now playing).
     */
